...
// Header file(s): `add.h`, `calc.h`, `multiply.h`, `subtract.h`
// Do not edit this file manually -- it may be overwritten.
// Generated on: 2025-10-19 16:46:02

#include "../include/calc/add.h"
#include "../include/calc/calc.h"
#include "../include/calc/multiply.h"
#include "../include/calc/subtract.h"
#include <cstdlib>
#include <exception>
#include <format>
#include <print>
...
#define assert_eq(a, b, ...) \
    if(!((a) == (b))) doxy::failed(#a, #b, (a), (b), header_file, header_line __VA_OPT__(, __VA_ARGS__));
...
void
failed(std::string_view lhs_str, std::string_view rhs_str, const LHS& lhs, const RHS& rhs,
